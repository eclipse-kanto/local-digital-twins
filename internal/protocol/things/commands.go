...
// the defined JSON merge patch format (https://datatracker.ietf.org/doc/html/rfc7396).
...
func (cmd *Command) Envelope(headers *protocol.Headers) *protocol.Envelope {
	msg := &protocol.Envelope{
		Topic:   cmd.Topic,
		Path:    cmd.Path,
		Headers: headers,
	}
	msg.WithValue(cmd.Payload)
	return msg
}
